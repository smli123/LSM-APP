...
public class SmartPlugEventHandlerAddScene  extends SmartPlugEventHandler{
	Intent mIntent = new Intent(PubDefine.PLUG_AIRCON_ADDSCENE_ACTION);
		...
		if (0 == ret) {
	    	...
	    	if (0 == resid) {
	    		mIntent.putExtra("MESSAGE", 
	    				SmartPlugApplication.getContext().getString(R.string.smartplug_ctrl_addtimer_fail));	
	    	} else {
