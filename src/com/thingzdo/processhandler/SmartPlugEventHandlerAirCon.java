...
public class SmartPlugEventHandlerAirCon extends SmartPlugEventHandler {
	Intent mIntent = new Intent(PubDefine.PLUG_AIRCON_ACTION);
	@Override
		...
		try{
			...
			if (2 > buffer.length) {
		    	...
		    	mIntent.putExtra("MESSAGE", 
	    				SmartPlugApplication.getContext().getString(R.string.smartplug_oper_aircon_fail));
