...
public class PathView extends View {
	...
	public String[] hours={"1H","2H","3H","4H","5H","6H","7H","8H","9H","10H",};
	public String[] days={"星期一","星期二","星期三","星期四","星期五","星期六","星期日"};
	public String[] weeks={"第一周","第二周","第三周","第四周"};
	public String[] mouths={"一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月",};
	...
	private void init(Context cont){
		...
		linkPaint.setStrokeWidth(10);
		
	}
	
	public void setLinkPaintColor(int color) {
	...
	private void drawFrame(Canvas canvas){
		...
		canvas.drawLine(left+5, bottom, getWidth(), bottom, paintLine);
		float startY=xLineCount*xInterval+xInterval;
		canvas.drawLine(getWidth(), startY, getWidth(), bottom, paintLine);
