...
public class SmartPlugEventHandlerWindow extends SmartPlugEventHandler {
	Intent mIntent = new Intent(PubDefine.PLUG_WINDOW_ACTION);
	@Override
		...
		try{
			...
			if (2 > buffer.length) {
		    	...
		    	mIntent.putExtra("MESSAGE", 
	    				SmartPlugApplication.getContext().getString(R.string.smartplug_oper_window_fail));
