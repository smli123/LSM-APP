...
public class SmartPlugEventHandlerTVServer extends SmartPlugEventHandler {
	Intent mIntent = new Intent(PubDefine.PLUG_TV_SERVER_ACTION);
	@Override
		...
		try {
			...
			if (2 > buffer.length) {
				...
				mIntent.putExtra("MESSAGE", SmartPlugApplication.getContext()
						.getString(R.string.smartplug_oper_aled_fail));
