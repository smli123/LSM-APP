...
public class SmartPlugEventHandlerProtocol extends SmartPlugEventHandler {
		...
		try{
			...
			if (2 > buffer.length) {
		    	...
		    	mIntent.putExtra("MESSAGE", 
	    				SmartPlugApplication.getContext().getString(R.string.smartplug_oper_protocol_fail));
