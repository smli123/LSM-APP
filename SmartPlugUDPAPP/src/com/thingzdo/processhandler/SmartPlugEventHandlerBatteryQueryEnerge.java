...
public class SmartPlugEventHandlerBatteryQueryEnerge extends SmartPlugEventHandler {
	private Intent mIntent = new Intent(PubDefine.PLUG_BATTERY_QUERYENERGE_ACTION);
	...
	public void handleMessage(Message msg) {
		...
		String energe = buffer[EVENT_MESSAGE_HEADER+2];
		
		mIntent.putExtra("OPER_DATE", oper_date);
