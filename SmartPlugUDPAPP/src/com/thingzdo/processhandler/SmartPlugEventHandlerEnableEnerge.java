...
public class SmartPlugEventHandlerEnableEnerge extends SmartPlugEventHandler {
	Intent mIntent = new Intent(PubDefine.PLUG_ENABLEENERGE);	// 使能电量统计
	@Override
		...
		try{
			...
			if (2 > buffer.length) {
		    	...
		    	mIntent.putExtra("MESSAGE", 
	    				SmartPlugApplication.getContext().getString(R.string.smartplug_enable_charge_fail));
